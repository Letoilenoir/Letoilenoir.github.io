...
NB: This function does NOT automatically create a coherent progrerssion asccording to Music Theory as yet, it only presents the possible root notes that mastch the chosen Key Signature
